# Generated by Django 4.0.1 on 2022-03-02 12:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member_created_at', models.DateField(default=datetime.datetime(2022, 3, 2, 17, 52, 24, 29273))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(default=datetime.datetime(2022, 3, 2, 17, 52, 24, 29273))),
